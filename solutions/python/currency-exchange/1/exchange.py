...
def exchange_money(budget, exchange_rate):
    ...
    total_exchange_money = budget / exchange_rate
    return total_exchange_money
...
def exchangeable_value(budget, exchange_rate, spread, denomination):
    ...
    amount_in_new_currency = budget / actual_exchange_rate
    max_whole_units = int(amount_in_new_currency // denomination)
